...
extern char _end;
unsigned char *heap = &_end;
unsigned char *_heap_end = 0x20002000;
#else
unsigned char heapmem[1024 * 64];
unsigned char *heap = heapmem;
unsigned char *_heap_end = &heapmem[sizeof(heapmem)];

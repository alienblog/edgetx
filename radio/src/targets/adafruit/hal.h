...
#if defined(RADIO_X7) || defined(RADIO_X7ACCESS) || defined(RADIO_TX12) || defined(PCB_ARDUINO) || defined(RADIO_T8) || defined(RADIO_TPRO)
...
#if defined(PCB_ARDUINO) || defined(PCBX7)
...
#if defined(PCB_ARDUINO) || defined(PCBX9LITE)

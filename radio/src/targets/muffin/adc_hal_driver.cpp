...
static adc_channel_t channel[3] = {POT1_ADC_CHANNEL, POT2_ADC_CHANNEL,
                                   BATT_ADC_CHANNEL};
...
void adruino_adc_init(void)
{
  ...
  // background
  RTOS_CREATE_TASK_EX(taskIdADC, task_adc, "ADC task", taskADC_stack,
                      TASKADC_STACK_SIZE, TASKADC_PRIO, MIXER_TASK_CORE);
}
...
#define KEYS_GPIOC_PINS                                           \
  (KEYS_GPIO_PIN_EXIT | TRIMS_GPIO_PIN_LHR | TRIMS_GPIO_PIN_RVD | \
   TRIMS_GPIO_PIN_RVU | SWITCHES_GPIO_PIN_A)
#define KEYS_GPIOD_PINS                                               \
  (KEYS_GPIO_PIN_PAGEUP | KEYS_GPIO_PIN_PAGEDN | KEYS_GPIO_PIN_TELE | \
   TRIMS_GPIO_PIN_LHL | SWITCHES_GPIO_PIN_C_H | SWITCHES_GPIO_PIN_H)
#define KEYS_GPIOE_PINS                                                    \
  (KEYS_GPIO_PIN_MDL | TRIMS_GPIO_PIN_LVD | TRIMS_GPIO_PIN_LVU |           \
   TRIMS_GPIO_PIN_RHL | TRIMS_GPIO_PIN_RHR | SWITCHES_GPIO_PIN_B_L |       \
   SWITCHES_GPIO_PIN_C_L | SWITCHES_GPIO_PIN_D | SWITCHES_GPIO_PIN_E |     \
   SWITCHES_GPIO_PIN_F | SWITCHES_GPIO_PIN_G | ROTARY_ENCODER_GPIO_PIN_A | \
   ROTARY_ENCODER_GPIO_PIN_B)
#endif
...
#define ADC_SET_DMA_FLAGS()                                                  \
  ADC_DMA->HIFCR = (DMA_HIFCR_CTCIF4 | DMA_HIFCR_CHTIF4 | DMA_HIFCR_CTEIF4 | \
...
#define ADC_MAIN_SMPR1                                                    \
  (ADC_SAMPTIME << 0) + (ADC_SAMPTIME << 3) + (ADC_SAMPTIME << 6) +       \
      (ADC_SAMPTIME << 9) + (ADC_SAMPTIME << 12) + (ADC_SAMPTIME << 15) + \
      (ADC_SAMPTIME << 18) + (ADC_SAMPTIME << 21) +                       \
      ((ADC_SAMPTIME + 1)                                                 \
       << 24);  // TLite needs +1 for proper RTC Bat measurement.
#define ADC_MAIN_SMPR2                                                     \
  (ADC_SAMPTIME << 0) + (ADC_SAMPTIME << 3) + (ADC_SAMPTIME << 6) +        \
      (ADC_SAMPTIME << 9) + (ADC_SAMPTIME << 12) + (ADC_SAMPTIME << 15) +  \
      (ADC_SAMPTIME << 18) + (ADC_SAMPTIME << 21) + (ADC_SAMPTIME << 24) + \
      (ADC_SAMPTIME << 27);
#else
#define ADC_MAIN_SMPR1                                                    \
  (ADC_SAMPTIME << 0) + (ADC_SAMPTIME << 3) + (ADC_SAMPTIME << 6) +       \
...
#define ADC_GPIOA_PINS                                                     \
  (ADC_GPIO_PIN_STICK_RV | ADC_GPIO_PIN_STICK_RH | ADC_GPIO_PIN_STICK_LH | \
   ADC_GPIO_PIN_STICK_LV | ADC_GPIO_PIN_POT2)
...
#define INTMODULE_RCC_AHB1Periph \
  (RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_DMA2)
...
#define INIT_INTMODULE_BOOTCMD_PIN() \
...
#define EXTMODULE_RCC_AHB1Periph \
  (RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_DMA2)
...
// Trainer Port
#define TRAINER_RCC_AHB1Periph \
  (RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_DMA1)
...
#define TELEMETRY_DIR_OUTPUT() \
  TELEMETRY_DIR_GPIO->BSRRH = TELEMETRY_DIR_GPIO_PIN
#define TELEMETRY_DIR_INPUT() TELEMETRY_DIR_GPIO->BSRRL = TELEMETRY_DIR_GPIO_PIN
#else
#define TELEMETRY_DIR_OUTPUT() \
  TELEMETRY_DIR_GPIO->BSRRL = TELEMETRY_DIR_GPIO_PIN
...
#define TELEMETRY_EXTI_TRIGGER EXTI_Trigger_Rising
    ...
    defined(PCB_MUFFIN) || defined(RADIO_T8) || defined(RADIO_TPRO)
...
#define TRAINER_MODULE_CPPM_CCMR1 \
  (TIM_CCMR1_IC2F_0 | TIM_CCMR1_IC2F_1 | TIM_CCMR1_CC2S_0)
...
// SD - SPI2
#define SD_RCC_AHB1Periph \
  (RCC_AHB1Periph_GPIOD | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_DMA1)
...
#define SD_SPI SPI2
#define SD_SPI_BaudRatePrescaler \
  SPI_BaudRatePrescaler_4  // 10.5<20MHZ, make sure < 20MHZ
...
#define AUDIO_RCC_AHB1Periph \
  (RCC_AHB1Periph_GPIOE | RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_DMA1)
